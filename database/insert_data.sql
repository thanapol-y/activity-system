...
('Act001', 'ค่ายอบรมผู้นำนักศึกษา', 'พัฒนาทักษะภาวะผู้นำและการทำงานเป็นทีม เพื่อเตรียมความพร้อมในการเป็นผู้นำในอนาคต', 2568, 'Activity_Type_02', '2569-01-20', '08:00:00', 'R101', 100, '2569-01-19 10:00:00', 'approved', 'dean001', 'head001'),
('Act002', 'กีฬาสีภายใน', 'การแข่งขันกีฬาประจำปี เพื่อส่งเสริมสุขภาพและความสามัคคีในหมู่นักศึกษา', 2568, 'Activity_Type_03', '2569-02-03', '09:00:00', 'โถงใต้ตึกอาคารพร้อมมงคล', 2000, '2569-02-02 08:00:00', 'approved', 'dean001', 'head002'),
('Act003', 'วันท่องเที่ยวแห่งชาติ', 'กิจกรรมจิตอาสาทำความสะอาดแหล่งท่องเที่ยว ร่วมกันรักษาสิ่งแวดล้อม ปลูกต้นไม้ และสร้างจิตสำนึกในการอนุรักษ์มรดกทางวัฒนธรรม', 2568, 'Activity_Type_04', '2569-03-04', '09:00:00', 'R301', 20, '2569-02-28 12:00:00', 'approved', 'dean001', 'head003');
...
('076760305034-9', 'Act001', '2569-01-04 08:00:00', 'registered'),
('076760305034-9', 'Act002', '2569-01-04 10:00:00', 'registered'),
('076760305034-9', 'Act003', '2569-01-20 13:45:00', 'registered'),
-- นายสุขุม ลงทะเบียน Act001, Act002
('076760305001-8', 'Act001', '2569-01-10 12:00:00', 'registered'),
('076760305001-8', 'Act002', '2569-01-20 13:44:00', 'registered'),
-- นายธีรชาติ ลงทะเบียน Act001, Act002, Act003
('076760305040-6', 'Act001', '2569-01-20 13:44:00', 'registered'),
('076760305040-6', 'Act002', '2569-01-20 13:44:00', 'registered'),
('076760305040-6', 'Act003', '2569-01-20 13:45:00', 'registered'),
-- นายธนวุฒิ ลงทะเบียน Act003
('076760305012-5', 'Act003', '2569-01-20 10:25:00', 'registered'),
-- นายธนวัฒน์ ลงทะเบียน Act002
('076760305011-7', 'Act002', '2569-01-25 15:33:00', 'registered'),
-- นายกรวิชญ์ ลงทะเบียน Act001, Act003
('076760305018-2', 'Act001', '2569-01-26 10:00:00', 'registered'),
('076760305018-2', 'Act003', '2569-02-13 12:00:00', 'registered');
...
-- เช็คอิน Act001 (ค่ายอบรมผู้นำ - 20 ม.ค. 2569)
('076760305034-9', 'Act001', 'club001', '2569-01-20 08:10:00'),
('076760305001-8', 'Act001', 'club003', '2569-01-20 07:45:00'),
('076760305018-2', 'Act001', 'club003', '2569-01-20 07:55:00'),
-- เช็คอิน Act002 (กีฬาสีภายใน - 3 ก.พ. 2569)
('076760305034-9', 'Act002', 'club002', '2569-02-03 08:30:00'),
('076760305040-6', 'Act002', 'club001', '2569-02-03 08:10:00'),
('076760305011-7', 'Act002', 'club001', '2569-02-03 08:28:00'),
-- เช็คอิน Act003 (วันท่องเที่ยวแห่งชาติ - 4 มี.ค. 2569)
('076760305040-6', 'Act003', 'club004', '2569-03-04 09:04:00'),
('076760305012-5', 'Act003', 'club003', '2569-03-04 08:29:00'),
('076760305018-2', 'Act003', 'club002', '2569-03-04 08:37:00');
